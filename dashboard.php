...
<head>
    ...
    <title>Dashboard - A.B Café & Bar</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><span>BOSS A.B Café & Bar - Dashboard Overview</span></div>
                </nav>
            ...
            <footer class="bg-white sticky-footer">
                <div class="container my-auto">
                    <div class="text-center my-auto copyright"><span>Copyright © BOSS A & B - 2024</span></div>
                </div>
            </footer>
